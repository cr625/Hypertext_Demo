...
%% NOTE that all authors should submit their manuscripts for review in the ACM double-column format. Please use the \documentclass[sigconf,review,anonymous]{acmart} command to generate the output in a double-column format.
...
\title{A Persona Proxy for Web Archival}
...
\received[revised]{12 March 2025} %% interim new draft
\received[accepted]{5 June 2025}  %% publication version
